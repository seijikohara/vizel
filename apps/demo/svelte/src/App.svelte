...
$effect(() => {
  ...
  const localState = { cancelled: false };
  staticRequestState.cancelled = false;
  Object.assign(staticRequestState, localState);
  generateVizelStaticHtml({ markdown: markdownInput, flavor })
    ...
    .catch((error: unknown) => {
      if (localState.cancelled) return;
      staticHtml = "";
      staticError = error instanceof Error ? error.message : "Failed to render static HTML";
    });
  return () => {
...
<div class="app">
  ...
  <section class="features-section">
    ...
    <div class="features-toggles">
      ...
      <label class="feature-toggle">
        <input type="checkbox" bind:checked={features.staticView} />
  ...
  <main class="main">
    ...
    <div class="editor-section">
      <div class="editor-container">
        ...
        {/if}
        {#if features.staticView}
          <section class="static-preview" aria-label="Static HTML preview (server-renderable)">
            ...
            {#if staticError}
              <p class="static-preview-error">{staticError}</p>
            {:else}
              <!--
                HTML originates from `generateVizelStaticHtml`, which
                sanitises against the Vizel schema before returning. The
                string never contains consumer-supplied script content.
              -->
              <div class="static-preview-body">{@html staticHtml}</div>
            {/if}
          </section>
        {/if}
      </div>
